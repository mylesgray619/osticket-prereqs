...
<p>
<img src="https://i.imgur.com/HX8rcDm.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
<p>
...
<p>
Here I reloaded the server then clicked on sites, default, then osTicket. On the right side I clicked on "browse :80", this will open the osTicket site. Next I clicked on PHP manager, enable or disable an extension, then enabled three PHP extensions as shown above to ensure the osTicket has the necessary functionality. Afterwards I refreshed the osTicket site to have the latest version of the page with all the enabled extensions.
</p>
<br />
...
<p>
Here after I continue to set up the osTicket in the browser, I next intsall the HeiediSQL file that allows me to connect to the "MySQL" server. This creates a new "osTicket" database.
</p>
<br />
